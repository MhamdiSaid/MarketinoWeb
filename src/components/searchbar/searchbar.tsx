...
export default function SearchBar({widthValue}:{widthValue:number}){
    ...
    <div  className="searchbar"
        ...
        <p style={{fontSize:widthValue/20+"em",borderLeft:`${widthValue/(widthValue*10)}em solid black`,
            paddingLeft:"1%"
    }}>Filter</p>
        ...
        <div className="searchIcon" style={{fontSize:widthValue/20+"em",borderLeft:`${widthValue/(widthValue*10)}em solid #354859`} as any}>
